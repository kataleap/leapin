...
export const paymentPlanCreateSchema = refineInstallments(
...
export const paymentPlanUpdateSchema = refineInstallments(
  z.object({ ...shape, installments: shape.installments.optional() }).partial()
);
